...
const AboutPage: React.FC<AboutPageProps> = ({ pagesAnimatVar, arrowAnimateVar, arrowGlitch }) => {
  ...
  const [showNavProject, setShowNavProject] = useState(false)
  ...
  return (
    <div className="aboutPageDiv">
      <motion.div
        ...
        exit="exit"
      >
        <div className="aboutPageIntroCont">
          <svg
            viewBox="0 0 851 271"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="aboutPageIntroSvg"
          ...
          <div className="aboutPageIntroTyped">
            {startText && <ReactTyped strings={[`${aboutMe}`]} typeSpeed={8} cursorChar="█" onComplete={() => setShowSkills(true)} />}
          </div>
        </div>

...
const ProjectPage: React.FC<ProjectPageProps> = ({pagesAnimatVar}) => {
  ...
  const handleLeftArrow = () => {
    ...
    if (projectNumber === 0) {
      ...
      handleProjectShown(projectNumber)
    } 
    projectNumber --
    handleProjectShown(projectNumber)
  }
    ...
    <div className="pagesLayoutDiv">
      ...
      >
        <div className='projectDescripDiv'>
          ...
          {showProjects && <ProjectDescription projectShown={projectShown} />}
        </div>
       {showProjects && <ProjectScreen 
          projectShown={projectShown} 
          setprojectShown={setprojectShown} 
          handleArrowDirection={handleArrowDirection}
        />}

...
const JourneyPage: React.FC<JourneyPageProps> = ({pagesAnimatVar}) => {
      ...
      >
        <div className='journeyDescripDiv'>
          <div className='journeyTagDiv pageHeading'>
            <svg viewBox="0 0 480 70" fill="none" xmlns="http://www.w3.org/2000/svg" className='journeySvg'>
        ...
        <div className='journeyScreenHolder'>
          <JourneyScreen certExp={certExp} setCertExp={setCertExp}/>
        </div>
      </motion.div>
    </div>
  )
